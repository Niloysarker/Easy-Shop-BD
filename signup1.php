...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="#.php">Feedback .</style></a> | Call us : +8801744855559</span>
			</div>
...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			  <a href="#"><h1>Easyshopbd.com <span>Best online DEAL you DeservE</span></h1> </a>
		  </div>
...
<form action="acct_created1.php" method="post">
  ...
  <fieldset>
    ...
    <input type="password" id="passw" name="user_password" pattern=".{5,10}" require title="Password: 6 to 10 chars">	
	<label for="passw">Mobile:</label>
    <input type="tel" pattern="[\+]\d{12}" id="mobile" name="user_mobile" require title="Format:+880XXXXXXXXXX" value="+880">    
