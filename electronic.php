	  ...
	  <div class="head-t">
		...
		<ul class="megamenu skyblue">
			<li><a class="color1" href="index.php">Home</a></li>
				...
				<li><a class="color8" href="watches.php">WATCHES</a></li>
				<li class="active grid"><a class="color9" href="watches.php">Electronics</a></li>
                <li>
			...
			<div class="products-grids">
				<div class="col-md-8 products-grid-left">
					...
					if(isset($_GET['filter_price']))
					{
						...
						if($price == 0)
						$sql = " SELECT * FROM products WHERE p_type LIKE 'Electronic'";					
						if($price == 1)
						$sql = " SELECT * FROM products WHERE p_price < 500 AND p_type LIKE 'Electronic'";
						if($price == 2)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 500 AND 1000 AND p_type LIKE 'Electronic'";
						if($price == 3)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 1000 AND 2000 AND p_type LIKE 'Electronic'";
						if($price == 4)
						$sql = " SELECT * FROM products WHERE p_price > 2000 AND p_type LIKE 'Electronic'";
						if (!$conn) {
							...
							while($row = mysqli_fetch_assoc($result)) 
							{
								...
								<div class="products-grd">
									<div class="p-one simpleCart_shelfItem prd">
										...
										<h4>'.$row["p_name"].'</h4>
										<p><a class="item_add" href="addcart.php?mycart='.$row['p_id'].'&userid='.$id.'"><span class=" item_price valsa">Tk. '.$row["p_price"].' .</span><img src="images/cartadd.png"></img> </a></p>
										<div class="pro-grd">
					...
					{
						$sql = " SELECT * FROM products WHERE p_type = 'Electronic'";
						if (!$conn) {
							die("Connection failed: " . mysqli_connect_error());
						}
						$result = mysqli_query($conn, $sql);
